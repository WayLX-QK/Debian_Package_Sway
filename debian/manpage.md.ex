% sway-config-debian(SECTION) | User Commands
%
% "July  5 2026"
...
sway-config-debian - program to do something

# SYNOPSIS

**sway-config-debian** **-e** _this_ [**\-\-example=that**] [{**-e** | **\-\-example**} _this_]
                 [{**-e** | **\-\-example**} {_this_ | _that_}]

**sway-config-debian** [{**-h** | *\-\-help**} | {**-v** | **\-\-version**}]

# DESCRIPTION

This manual page documents briefly the **sway-config-debian** and **bar** commands.

This manual page was written for the Debian distribution because the
original program does not have a manual page. Instead, it has documentation
in the GNU info(1) format; see below.

**sway-config-debian** is a program that...
...
:   The system-wide configuration file to control the behaviour of
    sway-config-debian. See **foo.conf**(5) for further details.
...
**sway-config-debian** provides some return codes, that can be used in scripts:
